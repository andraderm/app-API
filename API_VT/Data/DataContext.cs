...
namespace API_VT.Data
{
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Setor s5 = new Setor(5, "Logística");
            Setor s6 = new Setor(6, "Estoque");
            Setor s7 = new Setor(7, "Brigada de Incêndio");
            Setor s8 = new Setor(8, "Recepção");

            Funcionario f1 = new Funcionario(1, "Fábio", "Torres", new DateTime(2018, 02, 20), 12.10, 3, 1);
            Funcionario f2 = new Funcionario(2, "João", "Paulo", new DateTime(2017, 08, 03), 15.60, 1, 2);
            Funcionario f3 = new Funcionario(3, "Antônio", "Figueiredo", new DateTime(2017, 05, 28), 9.40, 1, 6);
            Funcionario f4 = new Funcionario(4, "Mariana", "Silva", new DateTime(2019, 01, 09), 11.20, 2, 5);
            Funcionario f5 = new Funcionario(5, "Maria", "José", new DateTime(2016, 04, 17), 10.40, 3, 8);
