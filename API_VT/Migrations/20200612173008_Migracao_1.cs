        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DespesaMensal = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 12.1, new DateTime(2018, 2, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, "Fábio", 1, "Torres" },
                    { 8, 7.5999999999999996, new DateTime(2018, 6, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, "Fabiana", 1, "Alves" },
                    { 2, 15.6, new DateTime(2017, 8, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "João", 2, "Paulo" },
                    ...
                    { 4, 11.199999999999999, new DateTime(2019, 1, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, "Mariana", 5, "Silva" },
                    { 14, 9.5999999999999996, new DateTime(2017, 5, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, "Regina", 5, "Pires" },
                    { 3, 9.4000000000000004, new DateTime(2017, 5, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "Antônio", 6, "Figueiredo" },
                    { 10, 13.300000000000001, new DateTime(2018, 11, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), 4, "Bruna", 7, "Ferraz" },
                    { 5, 10.4, new DateTime(2016, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, "Maria", 8, "José" },
